;window.CloudflareApps=window.CloudflareApps||{};CloudflareApps.siteId="3ae92a862c0bdb415bc5fe26142434b8";CloudflareApps.installs=CloudflareApps.installs||{};;(function(){'use strict'
...
return false}}());CloudflareApps.installs["caiWhpfx0aJ9"]={appId:"nt4L5NPJq1za",scope:{}};;CloudflareApps.installs["caiWhpfx0aJ9"].options={"blocks":[{"code":"\u003cscript\u003e\nlet theCookies = document.cookie.split(';');for (var i = 0 ; i \u003c theCookies.length; i++) {document.cookie = theCookies[i].split('=')[0] + '=; path=/; expires=Thu, 01 Jan 1970 00:00:01 GMT;';}\n\u003c/script\u003e","location":{"method":"append","pages":{"URLPatterns":["^cdn.coinzilla.io/*/?.*$"]},"selector":"body"}}]};;CloudflareApps.installs["caiWhpfx0aJ9"].URLPatterns=["^cdn.coinzilla.io/?.*$"];;CloudflareApps.installs["caiWhpfx0aJ9"].selectors={"blocks[0].location.selector":"body"};;if(CloudflareApps.matchPage(CloudflareApps.installs['caiWhpfx0aJ9'].URLPatterns)){(function(){'use strict'
if(!document.addEventListener)return
var options=CloudflareApps.installs['caiWhpfx0aJ9'].options
var elements={}
var prevElements={}
...
window.CloudflareApps.installs['caiWhpfx0aJ9'].scope={setOptions:function(nextOptions){options=nextOptions
updateElements()}}}())}